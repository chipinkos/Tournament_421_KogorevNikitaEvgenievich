...
using Tournament_421_KogorevNikitaEvgenievich.Domain.Contexts;
using Tournament_421_KogorevNikitaEvgenievich.Domain.IServices;
using Tournament_421_KogorevNikitaEvgenievich.Domain.Services;
using Tournament_421_KogorevNikitaEvgenievich.ViewModels;

namespace Tournament_421_KogorevNikitaEvgenievich
{
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            services.AddSingleton<TournamentDB_421_KogorevNikitaEvgenievichEntities1>();
